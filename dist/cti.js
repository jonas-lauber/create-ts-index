...
var createTypeScriptIndex_1 = require("./createTypeScriptIndex");
var option = {
    globOptions: {},
};
// -f -n -s -t -e -x -i -c
...
values) { return values.split(/[ |,]/).map(function (value) { return value.trim(); }); })
...
(function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, createTypeScriptIndex_1.createTypeScriptIndex(option)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
